...
impl<'i> Visitor<Result<Value>> for Interpreter<'i> {
    ...
    fn visit_p_array(&mut self, nodes: &[Node]) -> Result<Value> {
        todo!()
    }

    fn visit_b_array(&mut self, nodes: &[Node]) -> Result<Value> {
        todo!()
    }
    ...
    fn visit_p_tuple(&mut self, nodes: &[Node]) -> Result<Value> {
        todo!()
    }

    fn visit_b_tuple(&mut self, nodes: &[Node]) -> Result<Value> {
        todo!()
    }

    fn visit_number(&mut self, number: f64) -> Result<Value> {
        todo!()
    }

    fn visit_string(&mut self, string: &str) -> Result<Value> {
        todo!()
    }

    fn visit_buffer(&mut self, buffer: &str) -> Result<Value> {
        todo!()
    }

    fn visit_symbol(&mut self, symbol: &str) -> Result<Value> {
        todo!()
    }

    fn visit_keyword(&mut self, keyword: &str) -> Result<Value> {
        todo!()
    }

    fn visit_true(&mut self) -> Result<Value> {
        todo!()
    }

    fn visit_false(&mut self) -> Result<Value> {
        todo!()
    }
